...
const Painel = () => {
  ...
  const handleLogout = () => {
    axios.get('http://localhost:10000/auth/logout')
    .then(result => {
  ...
  const getAdminTotal = () => {
    axios.get('http://localhost:10000/auth/admin_count')
    .then(result => {
        if(result.data.Status){
  ...
  const getUsuarioTotal = () => {
    axios.get('http://localhost:10000/auth/user_count')
    .then(result => {
        if(result.data.Status){
  ...
  const getSalariosTotal = () => {
    axios.get('http://localhost:10000/auth/salario_count')
    .then(result => {
        if(result.data.Status){
  ...
  const getDesTotal = () => {
    axios.get('http://localhost:10000/auth/des_count')
    .then(result => {
        if(result.data.Status){
  ...
  const getTotalSAdmin = () => {
    axios.get('http://localhost:10000/auth/salarioad_count')
    .then(result => {
        if(result.data.Status){
  ...
  const getTotalSDes = () => {
    axios.get('http://localhost:10000/auth/salariodes_count')
    .then(result => {
        if(result.data.Status){
  ...
  const getAdmins = () => {
    axios.get('http://localhost:10000/auth/admin_list')
    .then(result => {
        if(result.data.Status){
  ...
  const handleDelete = (id) => {
    axios.delete('http://localhost:10000/auth/excluir_usuario/'+id)
    .then(result => {
      if(result.data.Status){
