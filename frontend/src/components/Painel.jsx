...
const Painel = () => {
  ...
  const getSalariosTotal = () => {
    axios.get('http://localhost:3000/auth/salario_count')
    .then(result => {
        if(result.data.Status){
  ...
  const getDesTotal = () => {
    axios.get('http://localhost:3000/auth/des_count')
    .then(result => {
        if(result.data.Status){
  ...
  const getTotalSAdmin = () => {
    axios.get('http://localhost:3000/auth/salarioad_count')
    .then(result => {
        if(result.data.Status){
  ...
  const getTotalSDes = () => {
    axios.get('http://localhost:3000/auth/salariodes_count')
    .then(result => {
        if(result.data.Status){
