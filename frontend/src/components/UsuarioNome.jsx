...
const UsuarioNome = () => { 
  ...
  var table = usuarioNome.filter(val => val.nome.includes(buscanome))
       ...
       <div className="col p-0 m-0">
           ...
           <div className="px-5 mt-5">                  
                <div id="conteudo">
                  ...
                  <div className="mb3">
                  <label htmlFor="Nome" style={{color: 'white', fontSize: '25px'}}>Busca por nome:</label><br />
                  <input type="search" style={{width: 300, padding: '4px'}} value={buscanome} onChange={(e) => setBuscaNome(e.target.value)} />  
                  </div>                             
                 </div>                           
